                ...
                <tbody>
                  <?php
                      try {
                        ...
                        $sql = "SELECT * FROM project ORDER BY projDate DESC";
                        ...
                        do {
                            ...
                            echo '<td class="text-center">';
                                echo "<a class='btn btn-default btn-xs' onClick=\"javascript: return confirm('You are going to view plots from the ". $projTitle ." project');\" href='viewPlots.php?projId=".$projId."' data-toggle='tooltip' data-placement='top' title='view plots'>";
                            ...
                            echo '<td class="text-center">';
                                echo "<a class='btn btn-default btn-xs' onClick=\"javascript: return confirm('You are going to print the ". $projTitle ." project');\" href='printProject.php?projId=".$projId."' data-toggle='tooltip' data-placement='top' title='print project'>";
