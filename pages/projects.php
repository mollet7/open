  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <!-- form start -->
        <form role="form" method="POST" action="myQueries/projectsProcess.php">
            <div class="box-body">
              Add New Projects
                ...
                <div class="row">
                    ...
                    <!--<div class="col-sm-5">
                        <div class="form-group">
                          ...
                          <select class="form-control select2" style="width: 100%;" required="required" name="projStatus" required="required">
                        ...
                        do {
                            ...
                            echo '<tr>';
                              ...
                              echo '<td class="text-center">';
                                echo '<button type ="button" class="btn btn-default btn-xs identifyingClassUpl" data-toggle="modal" data-target="#myModalUpl" data-id="'.$projId.'" title="upload plots file">
                                  Upload&nbsp;&nbsp;<span class="fa fa-upload"></span>
                                </button>';
                              echo '</td>';

                              echo '<td class="text-center">';
                                echo '<button type ="button" class="btn btn-default btn-xs identifyingClassAdd" data-toggle="modal" data-target="#myModalAdd" data-id="'.$projId.'" title="add single plot">
                                  Add new&nbsp;&nbsp;<span class="fa fa-plus"></span>
                                </button>';
                              echo '</td>';

                            echo '<td class="text-center">';
                                echo "<a class='btn btn-default btn-xs' href='viewPlots.php?projId=".$projId."' data-toggle='tooltip' data-placement='top' title='view plots'>";
                                  echo 'View&nbsp;&nbsp;<span class="fa fa-eye"></span>
                                </a> 
                            </td>';

                            echo '<td class="text-center">';
                                echo '<button type ="button" class="btn btn-default btn-xs identifyingClassUpd" data-toggle="modal" data-target="#myModalUpd" data-id="'.$projId.'" title="update project">
...
<!-- Modal -->
  ...
  <script>
    ...
    $('body').on('click', '.identifyingClassUpl', function() {
     var my_id_value = $(this).data('id');
     $("#myModalUpl #projId").val( my_id_value );
	});

	$('body').on('click', '.identifyingClassUpd', function() {
     var my_id_value = $(this).data('id');
     $("#myModalUpd #projId").val( my_id_value );
	});

	$('body').on('click', '.identifyingClassAdd', function() {
     var my_id_value = $(this).data('id');
     $("#myModalAdd #projId").val( my_id_value );
	});
